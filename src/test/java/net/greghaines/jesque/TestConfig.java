...
public class TestConfig {
    ...
    public void testConstructor_NullHost() {
        new Config(null, 0, -1, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_EmptyHost() {
        new Config("", 0, -1, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_LowPort() {
        new Config("foo", 0, -1, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_HighPort() {
        new Config("foo", Integer.MAX_VALUE, -1, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_NegativeTimeout() {
        new Config("foo", 123, -1, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_NullNamespace() {
        new Config("foo", 123, 0, null, null, -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_EmptyNamespace() {
        new Config("foo", 123, 0, null, "", -1, false);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_NegativeDatabase() {
        new Config("foo", 123, 0, null, "bar", -1, false);
    }

    @Test
    public void testConstructorAndGetters() {
        final Config config = new Config("foo", 123, 456, "secret", "bar", 10, false);
